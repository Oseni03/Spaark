...
export const auth = betterAuth({
	...
	account: {
		...
		accountLinking: {
			enabled: true,
			trustedProviders: ["google", "email-password"], // Since we have Google OAuth configured
			updateUserInfoOnLink: true, // Update user info when linking new accounts
			allowUnlinkingAll: false, // Prevent account lockout
		},
	},
	socialProviders: {
		google: {
