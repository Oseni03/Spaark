...
export const transformPortfolio = (portfolio) => {
	...
	return {
		...
		metadata: { ...defaultMetadata, ...JSON.parse(portfolio.metadata) },
...
export const getSocialIcon = (social) => {
	if (social.network === "github")
		return <IconBrandGithubFilled weight="fill" size={4} />;
	else if (social.network === "linkedin")
		return <IconBrandLinkedinFilled weight="fill" size={4} />;
	else if (social.network === "x")
		return <IconBrandXFilled weight="fill" size={4} />;
	else if (social.network === "youtube")
		return <IconBrandYoutubeFilled weight="fill" size={4} />;
};
